...
<head>
    ...
    <meta name="twitter:title" content="Web develoment">
    ...
    <meta property="og:title" content="Menzatyx - Web develoment"/>
    ...
    <!-- Menzatyx -->
    <title>Menzatyx - Web develoment</title>
                    ...
                    <li class="item">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <p><a hreflang="es" href="/es/webdeveloment"><img src="/assets/media/spain.webp" alt="Bandera de España">Español</a></p>
                                <p><a hreflang="en" href="/webdeveloment"><img src="/assets/media/uk.webp" alt="Bandera de Reino Unido">English</a></p>
                            </div>
                        </div>
                    </li>
                    <li class="item">
        ...
        <div class="all">
            <div class="head">
                <div class="tags">
                    ...
                    <a href="/es/webdeveloment" id="target" class="tag"> <i class="fa-sharp fa-solid fa-circle-check"></i> Web Develoment</a>
            ...
            <div class="containers">
                ...
                ?>
                <a class="container">
                    <img src="/assets/media/wd/notification.webp" width="auto" height="70%" alt="Notification">
                    <h1>Notificación</h1>
                    <div>
                        <button class="download" onclick="window.location.href='/es/things/wd/notification'">Descargar</button>
                        <button class="more" onclick="window.location.href='/es/things/wd/notification'">Ver más</button>
                    </div>
                </a>
                <a class="container">
                    <img src="/assets/media/all/button.webp" width="auto" height="70%" alt="botón">
                    <h1>Botón</h1>
                    <div>
                        <button class="download" onclick="window.location.href='/es/things/wd/button#download'">Descargar</button>
                        <button class="more" onclick="window.location.href='/es/things/wd/button'">Ver más</button>
                    </div>
                </a>
                <a class="container">
                    <img src="/assets/media/all/3dbutton.webp" width="auto" height="70%" alt="botón 3d">
                    <h1>Botón</h1>
                    <div>
                        <button class="download" onclick="window.location.href='/es/things/wd/3dbutton#download'">Descargar</button>
                        <button class="more" onclick="window.location.href='/es/things/wd/3dbutton'">Ver más</button>
                    </div>
                </a>
