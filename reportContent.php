    ...
    <div class="modal-content">
        ...
        <form method="post">
            <select id="report" name="select">
                ...
                <option value="iohc">Illegal or harmful content</option>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($select == 'o') {
        ...
        $reasons = array(
            ...
            "ms" => "Mention suicide",
            "hs" => "Hate speech",
            "iohc" => "Illegal or harmful content",
    ...
    $currentData = file_get_contents('../../contentReports.json');
    $currentDataArray = json_decode($currentData, true);
    $currentDataArray['contentReports'][] = $reportData;
    ...
    if (file_put_contents('../../contentReports.json', $jsonData)) {
        ...
        // Update button style and close modal
        echo "<script>
